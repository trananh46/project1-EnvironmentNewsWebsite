...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="up-video-admin.css">
    </head>
    ...
    <body>
        ...
        <div class="content">
            ...
            <?PHP
            include("../connect/open.php");
            $sql = "SELECT * FROM `video` WHERE trangThai=1 AND maADMIN ORDER BY `video`.`maVideo` DESC ";
            $result = mysqli_query($con, $sql);
            include("../connect/close.php");
            ?>
            ...
            <div class="hien-thi-video">
                <?PHP while ($video = mysqli_fetch_array($result)) { ?>
                    ...
                    <div class="right">
                        ...
                        <div class="button">
                            <ul>
                                <li><a href="update-video.php?ma-video=<?PHP echo $video["maVideo"] ?>">UPDATE</a></li>
                                <li><a href="delete-video-process.php?ma-video= <?PHP echo $video["maVideo"] ?>" onclick="return confirm('Do You Want to Delete VIDEO ?')">DELETE</a></li>
                            </ul>
                        </div>
