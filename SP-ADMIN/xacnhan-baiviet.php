...
<body>
    ...
    <div class="content">
        ...
        if (isset($_GET["search"])) {
            ...
            $sql = "SELECT * FROM `baiviet` INNER JOIN danhmuc on baiviet.maDanhMuc = danhmuc.maDanhMuc WHERE maUSER AND trangThai=0 ORDER BY `maBaiViet` DESC LIMIT $start,$limit";
        }
        $result = mysqli_query($con, $sql);
        include("../connect/close.php");
        ?>
        ...
        <div class="xem-baiviet">
            <?PHP while ($baiViet = mysqli_fetch_array($result)) { ?>
                ...
                <div class="bai-viet">
                    ...
                    <div class="right">
                        <div class="button">
                            <ul>
                                <li><a href="xacnhan-baiviet-user.php?ma-baiviet=<?PHP echo $baiViet["maBaiViet"] ?>">CONFIRM</a></li>
