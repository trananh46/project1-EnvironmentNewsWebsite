<?PHP
if (
    isset($_POST["ten-baiviet"]) && isset($_POST["noi-dung"]) && isset($_POST["danh-muc"])
    && isset($_POST["mieu-ta"]) && isset($_FILES["image"]) && isset($_POST["date"]) && isset($_POST["nguoi-dang"])
) {
    $tenBaiViet = $_POST["ten-baiviet"];
    $noiDung = $_POST["noi-dung"];
    $mieuTa = $_POST["mieu-ta"];
    $danhMuc = $_POST["danh-muc"];
    $image = $_FILES["image"];
    $date = $_POST["date"];
    ...
    VALUES (NULL, '$tenBaiViet', '$noiDung', '$mieuTa', '$direction', '$danhMuc', '$date', '$nguoiDang', NULL, '1')";
...
<?PHP
    ...
    header("Location: trangchuSP-ADMIN.php");
}
?>