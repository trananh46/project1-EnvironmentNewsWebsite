...
if (isset($_POST["ten-anh"]) && isset($_FILES["image"]) && isset($_POST["nguoi-dang"])) {
    ...
    $sql = "INSERT INTO `anh` (`maAnh`, `tenAnh`, `Anh`, `ngayDang`, `maADMIN`, `maUSER`, `trangThai`) VALUES (NULL, '$tenAnh', '$direction', '$date', NULL, '$nguoiDang', '0')";
    mysqli_query($con, $sql);
    include("../connect/close.php");
    header("Location: user-up-anh.php");
}
