...
<body>
    ...
    <div class="content">
        ...
        if (isset($_GET["search"])) {
            ...
            $sql = "SELECT * FROM `baiviet` INNER JOIN danhmuc on baiviet.maDanhMuc = danhmuc.maDanhMuc WHERE maUSER AND trangThai=1 ORDER BY `maBaiViet` DESC LIMIT $start,$limit";
        }
        $result = mysqli_query($con, $sql);
        include("../connect/close.php");
        ?>
