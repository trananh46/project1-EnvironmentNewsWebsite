...
<body>
    ...
    <?PHP
    include("../connect/open.php");
    $sql = "SELECT * FROM `baiviet` WHERE maADMIN AND maDanhMuc=7  ORDER BY `baiviet`.`maBaiViet` DESC LIMIT 0,3";
    $result = mysqli_query($con, $sql);
    include("../connect/close.php");
    ?>
    ...
    <div class="button-baiviet-moinhat">
        <a href="environment1.php">ĐỌC THÊM</a>
    </div>
    ...
    <div class="video-trangchinh">
        ...
        <div class="title-video">
            ...
            <div class="titile-video-thongtinVideo3">
                <a href="environment1.php">KHÁM PHÁ</a>
            </div>
        </div>
    </div>
    <br>
